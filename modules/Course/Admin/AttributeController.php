...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'course');
        ...
        return view('Course::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'course')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Course'),
        ...
        return view('Course::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Course::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/course/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('Course::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('course');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('course',$q);
    ...
    {
        $q = $request->query('q');
        $query = $this->attributesClass::selectRaw("id,name as text")->where('service','course');
        if ($q) {
