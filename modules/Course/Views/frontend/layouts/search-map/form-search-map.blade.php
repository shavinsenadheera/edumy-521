<form action="{{url( app_get_locale(false,false,'/').config('course.course_route_prefix') )}}" class="form bravo_form d-flex justify-content-start" method="get" onsubmit="return false;">
    <div class="filter-item">
        <div class="form-group">
            ...
            <div class="form-content">
                ...
                $traverse($course_location);
                ?>
                <div class="smart-search">
                    <input type="text" class="smart-search-location parent_text form-control" {{ ( empty(setting_item("course_location_search_style")) or setting_item("course_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Where are you going?")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}"
