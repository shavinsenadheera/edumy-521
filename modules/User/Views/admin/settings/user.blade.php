...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            <h3 class="form-group-title">{{__("Setting")}}</h3>
            <p class="form-group-desc">{{__('Config setting option')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls form-group-image">
                            {!! \Modules\Media\Helpers\FileHelper::fieldUpload('users_page_list_banner',$settings['users_page_list_banner'] ?? "") !!}
                        </div>
                    </div>
                </div>
            </div>
