        ...
        <div class="container">
            ...
            <div class="lang-content-box">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="panel">
                            <div class="panel-title"><strong>{{__('Hide Breadcrumbs')}}</strong></div>
                            <div class="panel-body">
                                @if(is_default_lang())
                                    <div>
                                        <label><input @if($row->hide_bc) checked @endif type="radio" name="hide_bc" value="1"> {{__("Hide")}}
                                        </label></div>
                                    <div>
                                        <label><input @if(empty($row->hide_bc)) checked @endif type="radio" name="hide_bc" value="0"> {{__("Show")}}
                                        </label></div>
                                @endif
                            </div>
                        </div>
