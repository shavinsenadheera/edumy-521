        ...
        <div class="tab-content" data-condition="seo_index:is(1)">
            <div class="tab-pane active" id="seo_1">
                ...
                <div class="form-group">
                    ...
                    <textarea name="seo_desc" rows="3" class="form-control" placeholder="{{!empty($row->short_desc) ? strip_tags($row->short_desc) : __("Enter description...")}}">{{$meta_seo['seo_desc'] ?? ""}}</textarea>
                </div>
                @if(is_default_lang())
            ...
            <div class="tab-pane" id="seo_2">
                ...
                <div class="form-group">
                    ...
                    <textarea name="seo_share[facebook][desc]" rows="3" class="form-control" placeholder="{{!empty($row->short_desc) ? strip_tags($row->short_desc) : __("Enter description...")}}">{{$seo_share['facebook']['desc'] ?? "" }}</textarea>
                </div>
                @if(is_default_lang())
                    <div class="form-group form-group-image">
            ...
            <div class="tab-pane" id="seo_3">
                ...
                <div class="form-group">
                    ...
                    <textarea name="seo_share[twitter][desc]" rows="3" class="form-control" placeholder="{{!empty($row->short_desc) ? strip_tags($row->short_desc) : __("Enter description...")}}">{{$seo_share['twitter']['desc'] ?? "" }}</textarea>
                </div>
                @if(is_default_lang())
                    <div class="form-group form-group-image">
