        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>{{__("Logo Sub")}}</label>
                        <div class="form-controls form-group-image">
                            {!! \Modules\Media\Helpers\FileHelper::fieldUpload('logo_sub_id',$settings['logo_sub_id'] ?? '') !!}
                        </div>
                    </div>
                @endif
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <div id="footer_text_left_editor" class="ace-editor" style="height: 400px" data-theme="textmate" data-mod="html">{{setting_item_with_lang('footer_text_left',request()->query('lang'))}}</div>
                        <textarea class="d-none" name="footer_text_left" > {{ setting_item_with_lang('footer_text_left',request()->query('lang')) }} </textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="">{{__("Copyright Text")}}</label>
                        <div class="form-controls">
                            <input type="text" class="form-control" name="copyright_text" value="{{setting_item_with_lang('copyright_text',request()->query('lang'),"Copyright Edumy © 2019. All Rights Reserved.")}}">
                        </div>
                    </div>
            </div>
        </div>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label>{{__("Fax")}}</label>
                    <div class="form-controls">
                        <input type="text" class="form-control" name="contact_fax" value="{{$settings['contact_fax'] ?? '' }}">
                    </div>
                </div>
                <div class="form-group">
                    <label>{{__("Location")}}</label>
                    <div class="form-controls">
                        <input type="text" class="form-control" name="contact_location" value="{{$settings['contact_location'] ?? '' }}">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                @if(is_default_lang())
                    <div class="form-group">
                        <label>{{__("Contact Banner Image")}}</label>
                        <div class="form-controls form-group-image">
                    ...
                    <div class="control-map-group">
                        ...
                        <div class="g-control">
                            <div class="form-group">
                                ...
                                <input type="text" name="map_lat" class="form-control" value="{{$settings['map_lat'] ?? ''}}" onkeydown="return event.key !== 'Enter';">
                            </div>
                            <div class="form-group">
                                <label>{{__("Map Longitude")}}:</label>
                                <input type="text" name="map_lng" class="form-control" value="{{$settings['map_lng']?? ''}}" onkeydown="return event.key !== 'Enter';">
                            </div>
                            <div class="form-group">
                                <label>{{__("Map Zoom")}}:</label>
                                <input type="text" name="map_zoom" class="form-control" value="{{$settings['map_zoom'] ?? "8"}}" onkeydown="return event.key !== 'Enter';">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        jQuery(function ($) {
            new BravoMapEngine('map_content', {
                disableScripts: true,
                fitBounds: true,
                center: [{{$settings['map_lat'] ?? "51.505"}}, {{$settings['map_lng'] ?? "-0.09"}}],
                zoom:{{$settings['map_zoom'] ?? "8"}},
                ready: function (engineMap) {
                    @if(!empty($settings['map_lat']) && !empty($settings['map_lng']))
                    engineMap.addMarker([{{$settings['map_lat']}}, {{$settings['map_lng']}}], {
                        icon_options: {}
                    });
                    @endif
