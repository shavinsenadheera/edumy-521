            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input type="text" name="style_main_color" value="{{$settings['style_main_color'] ?? '#555555'}}" class="has-colorpicker d-none">
                    </div>
                </div>
                @endif
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        @php $typo = json_decode(setting_item_with_lang_raw('style_typo',request()->query('lang')),true) @endphp
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
