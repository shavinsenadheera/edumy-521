(function($) {
    ...
    $(".btn-more-item").on('click', function() {
        $(this).closest(".ui_kit_checkbox").find(".hide").removeClass("hide");
        $(this).addClass("hide");
    });

    $(".bravo_form_filter input[type=checkbox]").change(function () {
        $(this).closest(".bravo_form_filter").trigger('submit');
    });
